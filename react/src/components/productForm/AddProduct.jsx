            ...
            <section className="container">
                ...
                <form className="form-primary">
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            <div className="question-box">
                                ...
                                <p className="md:w-[222px] xl:w-[360px] text-justify text-slate-500 sm:text-[12px] lg:text-sm font-normal leading-tight font-poppins tracking-wider">
                                    Nama produk minimal 40 karakter dengan memasukkan merek, jenis produk, warna, bahan, atau tipe.
                                </p>
                            </div>
                            <div className="question-input">
                                <input type="text" placeholder="Type here" className="sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[46px] self-stretch input input-bordered bg-primary-100" />
                            </div>
                        </div>
                        ...
                        <div className="form-card-box">
                            <div className="question-box">
                                ...
                                <p className="md:w-[222px] xl:w-[360px] text-justify text-slate-500 sm:text-[12px] lg:text-sm font-normal leading-tight font-poppins tracking-wider">
                                    Pilih kategori yang sesuai karena biaya layanan akan tergantung pada kategori. Jika pemilihan kategori kurang sesuai, maka kategori akan diubah oleh Admin
                                </p>
                            </div>
                            <div className="question-input">
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            <div className="question-box">
                                ...
                                <p className="md:w-[222px] xl:w-[360px] text-justify text-slate-500 sm:text-[12px] lg:text-sm font-normal leading-tight font-poppins tracking-wider">
                                    Format video .mp4 dan mov. Disarankan dirasi maksimal 120 detik dan ukuran maks 100MB.                                    
                                </p>
                            </div>
                            <div className="media-input">
                                <label htmlFor="file-upload" className="cursor-pointer gap-2 mx-auto">
                                    ...
                                    className="xl:w-6 xl:h-6 mx-auto"
                                    />
                                    <span className="text-black text-xs font-light">Upload Video</span>
                                </label>
                                <input
                                    id="file-upload"
                                    type="file"
                        ...
                        <div className="form-card-box">
                            ...
                            <div className="question-input">
                                <textarea className=" sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[229px] resize-none self-stretch textarea textarea-bordered bg-primary-100" placeholder="Bio"></textarea>  
                            </div>
                        </div>
                        ...
                        <div className="form-card-box">
                            <div className="question-box">
                                ...
                                <p className="md:w-[222px] xl:w-[360px] text-justify text-slate-500 sm:text-[12px] lg:text-sm font-normal leading-tight font-poppins tracking-wider">
                                    Pastikan memilih checkbox untuk ukuran baju yang tersedia, jika tidak ada ukuran tidak diwajibkan mengisi                                
                                </p>
                            </div>
                            <div className="question-input w-full flex justify-between sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[229px]">
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">S</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">M</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">L</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">XL</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">XXL</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                                <div className="form-control shadow md:w-[95px] sm:px-1">
                                    <label className="label cursor-pointer">
                                        <span className="label-text font-bold text-primary-0">XXXL</span> 
                                        <input type="checkbox" defaultChecked className="checkbox" />
                                    </label>
                                </div>
                            </div>
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            <div className="question-box">
                                ...
                                <p className="md:w-[222px] xl:w-[360px] text-justify text-slate-500 sm:text-[12px] lg:text-sm font-normal leading-tight font-poppins tracking-wider">
                                    Masukan discount jika memang ada, dan masukan angka 1 - 100 persen saja                                
                                </p>
                            </div>
                    ...
                    <div className="w-full inline-flex sm:gap-6 xl:gap-[21px] sm:justify-center md:justify-end">
                        <button className="btn btn-color-secondary btn-form-primary">Cancel</button>
                        <button className="btn btn-color-primary btn-form-primary">Save</button>
                    </div>
