                ...
                <form>
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            ...
                            <div className="question-input">
                                <input type="text" placeholder="Type here" className="sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[46px] self-stretch input input-bordered" />
                            </div>
                        </div>
                        ...
                        <div className="form-card-box">
                            ...
                            <div className="question-input">
                                <select className="select select-bordered sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[46px] self-stretch">
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            ...
                            <div className="question-input">
                                <textarea className=" sm:w-[248px] md:w-[360px] lg:w-[500px] xl:w-[603px] xl:h-[229px] resize-none self-stretch textarea textarea-bordered" placeholder="Bio"></textarea>  
                            </div>
                        </div>
                    </article>
                    ...
                    <article className="form-card">
                        ...
                        <div className="form-card-box">
                            ...
                            <div className="question-input-icon input input-bordered">
                    ...
                    <div className="w-full inline-flex sm:gap-3  xl:gap-[21px] sm:justify-center md:justify-end">
                        <button className="btn btn-primary-41">Cancel</button>
                        <button className="btn btn-primary-41">Save</button>
                        <button className="btn btn-primary-41">Draft</button>
                    </div>
                </form>
            </section>
        </>
